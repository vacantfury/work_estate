...
Since v3 the roster includes the infrastructure trio's adapters (store engine, finder sources, ties channels) and the seed's registry row — flag a stale update channel (newest version seen far ahead of installed, or last-checked ancient).
