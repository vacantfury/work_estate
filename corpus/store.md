...
- **Views, not copies.** Once the store runs, the markdown files sessions read (`people.md`, `benefits.md`, …) are RENDERED views; a hand edit to a view that carries judgment flows back as a new user-layer line, never silent divergence.
