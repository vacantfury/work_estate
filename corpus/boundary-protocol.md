...
- **Hard core, three lines:** employer-confidential content never leaves employer systems through the user's own channels · the user's private hub and dossier content never lands on this machine · the work engine's standing jobs run on work surfaces and the work account's budget only.
